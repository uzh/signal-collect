 ...
 */
class DSANTestVertex(id: Any, constraints: Iterable[Constraint], possibleValues: Array[Int]) extends DataGraphVertex(id, 0.0) {
...
//  
//  graph.addVertex(new DSANTestVertex(1, Array(c12), Array(0, 1)))
// graph.addVertex(new DSANTestVertex(2, Array(c12), Array(0, 1)))
// 
...
// graph.addEdge(new StateForwarderEdge(2, 1))
 ...
 //Graph with 6 nodes 
  ...
  graph.addVertex(new DSANTestVertex(1, Array(c12, c13), Array(0, 1, 2)))
  graph.addVertex(new DSANTestVertex(2, Array(c12, c23, c26), Array(0, 1, 2)))
  graph.addVertex(new DSANTestVertex(3, Array(c13, c23, c35, c34), Array(0, 1, 2)))
  graph.addVertex(new DSANTestVertex(4, Array(c34, c45), Array(0, 1, 2)))
  graph.addVertex(new DSANTestVertex(5, Array(c35, c45, c56), Array(0, 1, 2)))
  graph.addVertex(new DSANTestVertex(6, Array(c26, c56), Array(0, 1, 2)))
