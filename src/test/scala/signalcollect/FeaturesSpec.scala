...
//
//  val computeGraphBuilders: List[ComputeGraphBuilder] = List(DefaultBuilder, DefaultSynchronousBuilder)
//  val numberOfWorkers = List(1, 2, 4, 8, 16, 32, 64, 128)
//
//  def computeGraphs: List[ComputeGraph] = {
//    var computeGraphs = List[ComputeGraph]()
//    for (workers <- numberOfWorkers) {
//      for (computeGraphBuilder <- computeGraphBuilders) {
//        computeGraphs += computeGraphBuilder.withNumberOfWorkers(workers).build
//      }
//    }
//    computeGraphs
//  }
//
//  "Feature \repeated executions\"" should {
//    "deliver correct results when running PageRank" in {
//      val fourChainEdges = List((0, 1), (1, 2), (2, 3), (3, 4))
//      val fiveCycleExtensionEdge = List((4, 0))
...
//      listOfActions: List[ComputeGraph => Unit],
//      verify: Vertex[_, _] => Boolean): Boolean = {
//      var correct = true
...
//  }
//
//  "Repeated executions of the PageRank algorithm" should {
