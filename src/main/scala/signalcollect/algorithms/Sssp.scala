...
object SSSP extends App {
  ...
  cg.addVertex(classOf[Location], 1, Some(0))
  cg.addVertex(classOf[Location], 2, None)
  cg.addVertex(classOf[Location], 3, None)
  cg.addVertex(classOf[Location], 4, None)
  cg.addVertex(classOf[Location], 5, None)
  cg.addVertex(classOf[Location], 6, None)
  cg.addEdge(classOf[Path], 1, 2)
  cg.addEdge(classOf[Path], 2, 3)
  cg.addEdge(classOf[Path], 3, 4)
  cg.addEdge(classOf[Path], 1, 5)
  cg.addEdge(classOf[Path], 4, 6)
  cg.addEdge(classOf[Path], 5, 6)
