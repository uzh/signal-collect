...
class KryoInit {
  ...
  protected def register(kryo: Kryo): Unit = {
    try {
      ...
      register("com.signalcollect.deployment.Handlers$$anonfun$nonExistingVertex$1")
      register("com.signalcollect.deployment.Handlers$$anonfun$undeliverableSignal$1")
      ...
      register("akka.remote.RemoteWatcher$HeartbeatTick$")
//      register("akka.remote.RemoteWatcher$ReapUnreachableTick$")
      register("com.signalcollect.deployment.FileLoader")
//      register("java.io.BufferedReader")
//      register("[C")
//      register("java.io.FileReader")
//      register("java.io.FileInputStream")
//      register("java.io.FileDescriptor")
//      register("java.util.concurrent.atomic.AtomicInteger")
//      register("sun.nio.cs.StreamDecoder")
//      register("java.util.concurrent.atomic.AtomicInteger")
//      register("java.util.concurrent.atomic.AtomicInteger")
//      register("java.util.concurrent.atomic.AtomicInteger")
//      register("java.util.concurrent.atomic.AtomicInteger")
